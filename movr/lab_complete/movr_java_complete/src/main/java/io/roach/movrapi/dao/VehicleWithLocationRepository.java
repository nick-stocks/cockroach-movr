...
public interface VehicleWithLocationRepository extends JpaRepository<VehicleWithLocation, UUID> {
     ...
     *
     * The query:
     *     SELECT vehicles.id, vehicles.in_use, vehicles.serial_number,
