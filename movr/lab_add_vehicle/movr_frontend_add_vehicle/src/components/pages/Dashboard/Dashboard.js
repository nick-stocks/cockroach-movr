...
function Dashboard({ email, vehicleID, resetDash }) {
  ...
  */
   ...
   * Note that this is distinct from the startRides() function defined in
   * /src/redux/. I don't understand why it's any different.
   */
  const startRide = () => {
    ...
    axios.put(("/api/vehicles/" + id + "/checkout"), {
      ...
      .then(function (response) {
        // Not sure what action might be taken here.
      })
      .catch(function (error) {
