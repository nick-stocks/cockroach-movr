...
const VehicleDetails = ({
  ...
  const startRide = () => {
    try {
      // http request to start a ride based on vehicle's id
      // Used in the "Start ride" button below.
          ...
          <div className="card-body">
            ...
            <div style={{ display: "flex", justifyContent: "start" }}>
              ...
              <div className="text-left" style={{ marginLeft: "80px" }}>
                <div>
                  <p className="card-text text-left">Latitude</p>
                </div>
                <div>
                  <p className="card-text">
                    {usersinfo.last_latitude}
                  </p>
                </div>
              </div>
