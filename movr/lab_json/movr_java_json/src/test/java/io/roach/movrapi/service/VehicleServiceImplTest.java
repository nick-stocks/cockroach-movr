...
public class VehicleServiceImplTest {
    ...
    public void testAdd() {
        ...
        vehicleInfo.put(VEHICLE_TYPE_KEY, TEST_VEHICLE_TYPE);
        VehicleInfoDTO vehicleInfoDTO = new VehicleInfoDTO(vehicleInfo);

        vehicleService.addVehicle(TEST_NEW_LAT, TEST_NEW_LON, TEST_BATTERY, vehicleInfoDTO);
        ...
        String vehicleInfoString = vehicle.getVehicleInfo();
        JSONObject jsonObject = new JSONObject(vehicleInfoString);
        String vehicleType = jsonObject.get(VEHICLE_TYPE_KEY).toString();
    ...
    private Vehicle dummyVehicle(UUID vehicleId, boolean inUse) {
        ...
        jsonObject.put(VEHICLE_TYPE_KEY, TEST_VEHICLE_TYPE);
        vehicle.setVehicleInfo(jsonObject.toString());
