...
class Vehicle(Base):
    ...
    # LAB: YOU WILL NEED TO MODIFY THIS MODEL IN ORDER TO ADD A COMPUTED COLUMN
    # TO MOVR. IN THIS CASE, IT WILL NEED TO PASS AN OBJECT OF THE 
    # FetchedValue CLASS AS AN ARGUMENT TO Column().
    # REFERENCES:
    # https://docs.sqlalchemy.org/en/13/core/defaults.html#triggered-columns
    # https://docs.sqlalchemy.org/en/13/core/defaults.html#sqlalchemy.schema.FetchedValue
    id = Column(UUID)
